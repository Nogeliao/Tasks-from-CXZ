...
void cxz::sort_array_3d(int *** const pp_, const size_t &length_, const size_t &width_, const size_t &height_, OneDimensionalSort &obj_){
...
void cxz::BubbleSort::sort_array_1d(int* const p_, const size_t &len_, const size_t &unit_bias_){
...
void cxz::InsertionSort::sort_array_1d(int* const p_, const size_t &len_, const size_t &unit_bias_){
...
void cxz::SelectionSort::sort_array_1d(int* const p_, const size_t &len_, const size_t &unit_bias_){
    for (size_t i = 0; i < len_-1; i++)
    {
        size_t min = i;
